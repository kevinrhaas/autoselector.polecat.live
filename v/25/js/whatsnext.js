...
export const WHATSNEXT = [
  ...
  { status:'next', title:'Sources for every stat',
    detail:'Every vehicle page gets precise, verified citations (manufacturer 2026 pages, fueleconomy.gov, price guides) — 89 of 325 models are live (Toyota, Lexus, Subaru, Honda, Acura and Ford are fully cited), ~15 more per run until all 325 are cited.' },
