...
export const CHANGELOG = [
  {
    v: 85,
    title: 'Porsche lineup re-verified against 2026 pricing',
    kind: 'fix',
    ts: '2026-08-01T18:31:32.934Z',
    items: [
      'All 7 Porsche models (911, Cayenne, Cayenne Electric, Macan, Macan Electric, Panamera, Taycan) re-verified against manufacturer and price-guide sources for the current 2026 model year.',
      'Several missing trims added — Carrera S on the 911, GTS and E-Hybrid variants on the Cayenne, Macan T and GTS, Macan 4S/GTS Electric, four Panamera trims, and three Taycan trims — each priced from real, current listings.',
      'Corrected stale or mismatched figures — Porsche 2026 price increases, a Turbo S 911 that is now a 701-hp T-Hybrid rather than the outgoing engine, and Taycan MPGe/range numbers that did not match any real EPA record.',
      'Sources cited for every model; safety ratings checked directly with NHTSA and IIHS rather than assumed — none of the seven currently carry a rating, now stated explicitly instead of left blank.',
    ],
  },
  {
    v: 84,
  ...
  },
  {
    ...
    kind: 'fix',
    ts: '2026-08-01T12:20:31.237Z',
    items: [
      'CX-90 was missing 5 of its 9 real trims (Preferred, Premium Sport, Premium Plus, S Premium Sport gas, PHEV Premium Sport) and every price was stale from a mid-2026 increase — rebuilt the full lineup against mazdausa.com ($39,300-$59,295).',
      'Corrected the CX-30 and Mazda3\'s shared base 2.5L engine from a stale 191 hp to Mazda\'s official 186 hp, and added the new CX-30 Aire Edition trims and the CX-50 Turbo Meridian Edition trim.',
      'CX-5 raised to confidence high (wheelbase confirmed at 110.8 in, all 5 trims re-verified unchanged); CX-70 and MX-5 Miata re-checked with no changes needed.',
    ],
  },
  {
    v: 81,
