...
export const WHATSNEXT = [
  { status:'next', title:'Public ratings for every model',
    detail:'NHTSA safety stars, IIHS awards, and owner and expert scores — each source-linked. Live for 92 models today, rolling out to the rest, honestly omitting anything not yet published.' },
