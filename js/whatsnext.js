...
export const WHATSNEXT = [
  { status:'next', title:'Public ratings for every model',
    detail:'NHTSA safety stars, IIHS awards, and owner and expert scores — each source-linked. Every one of the 325 models has now been checked at least once; 160 carry a real rating, the rest have a confirmed reason they don’t (never tested, no 2026 record, or no award).' },
  { status:'next', title:'Interior & multi-photo galleries',
    detail:'Real cabin and extra-angle photos on every vehicle page — current generation only. 100 models live; expanding across the catalog.' },
  { status:'next', title:'Sources for every stat',
    detail:'Every vehicle page gets precise, verified citations (manufacturer 2026 pages, fueleconomy.gov, price guides) — 116 of 325 models are live, ~15 more per run until all 325 are cited.' },
